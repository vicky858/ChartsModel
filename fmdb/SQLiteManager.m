...
-(NSString*)GetDBPath
{
	...
	return [documentsDirectory stringByAppendingPathComponent:@"ChartsDB.sqlite"];
}
...
-(void)createDatabaseIfNeeded{
	...
	//Create the complete path to the database file.
	NSString *databasePath = [documentsDirectory stringByAppendingPathComponent:@"ChartsDB.sqlite"];
	...
	NSString *dbPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"ChartsDB.sqlite"];
